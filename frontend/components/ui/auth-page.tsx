...
export function AuthPage({ children }: AuthPageProps) {
    return (
        <main className="relative md:h-screen md:overflow-hidden lg:grid lg:grid-cols-2 bg-gradient-to-br from-[#000] to-[#1A2428] text-white">
            <div className="relative hidden h-full flex-col border-r border-white/10 p-10 lg:flex">
                <div className="from-black/50 absolute inset-0 z-10 bg-gradient-to-t to-transparent" />
                <div className="z-10 flex items-center gap-2">
                    <Grid2x2PlusIcon className="size-6" />
                    <p className="text-xl font-semibold">Portfolio Buzz</p>
                </div>
