                                ...
                                <div className="bg-white/5 border border-white/10 p-6 rounded-2xl flex flex-col gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center justify-between bg-black/30 p-3 rounded-xl border border-white/5">
                                            <span className="text-xs text-gray-400 uppercase tracking-wider">Nifty RSI</span>
                                            <div className={`text-lg font-bold ${data.market_indicators.nifty_rsi > 70 ? 'text-red-400' : data.market_indicators.nifty_rsi < 30 ? 'text-green-400' : 'text-blue-400'}`}>
                                                {data.market_indicators.nifty_rsi}
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div className="bg-white/5 border border-white/10 p-6 rounded-2xl">
                                    <h2 className="text-lg font-bold text-white flex items-center gap-2 mb-2">
                                        <PieChartIcon className="text-blue-400" size={20} /> Sector Allocation
                                    </h2>
...
function PieChartIcon(props: any) { return <PieIcon {...props} /> }
